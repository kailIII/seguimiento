...
<div class="container-narrow">
        ...
        <div class="navbar-inner">
          <div class="container">
            <ul class="nav">
              ...
              <li class="active"><a href="#">Vendidas</a></li>
  ...
  <?php 
    ...
    $result = mysql_query("SELECT DATE_FORMAT(hembras.time_hembra, '%m/%Y') AS 'date' , hembras.id_hembra, hembras.senasa_hembra, hembras.nacimiento_hembra, hembras.vacunas_hembra,
